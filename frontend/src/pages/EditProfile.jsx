...
const EditProfile = () => {
    ...
    return (
        <div className="min-h-screen bg-[#f9f9f9]">
            ...
            {/* Sidebar */}
            <aside className={`fixed left-0 top-16 bottom-0 z-40 max-[750px]:z-[9999]! transition-all duration-300 ${isSidebarOpen ? "w-50" : "w-14 sm:w-20"}`}>
                <Sidebar isSidebarOpen={isSidebarOpen} onClose={() => setIsSidebarOpen(false)} />
            </aside>

            {/* Main Content */}
            <main className={`pt-16 overflow-y-auto transition-all duration-300 ${isSidebarOpen ? 'pl-14 sm:pl-20 min-[750px]:pl-50!' : 'pl-14 sm:pl-20'}`}>
